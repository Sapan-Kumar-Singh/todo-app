...
const columnTypesConfig: any = {
  customeTextCell: {
    ...
    cellRenderer: (params: any) => {
      const displayValue = params?.data[params?.colDef?.field];
      return (
    ...
    cellRenderer: (params: any) => {
      ...
      return (
        <div style={{ position: "relative", width: "100%" }}>
          ...
          >
            <TextArea label="" uid={params?.colDef?.field} field={params?.colDef?.field} readonly={params?.colDef?.readonly} value={displayValue} insideGrid={true} />
          </div>
  ...
  CellDatePicker: {
    ...
    cellRenderer: (params: any) => {
      ...
      return (
        <div>
          <DateField name={"grid-date"} type={"date"} value={displayValue} readonly={params?.colDef?.readonly} insideGrid={true}/>
        </div>
      )
    }
  },
